...
musicTracksDirectory = '/home/pi/Desktop/Python Scripts/audio'
...
# def loadHighScores():
#     try:
#         with open(easyLeaderboard, 'r') as easyScoresFile:
#             easyHighScores = json.load(easyScoresFile)
#     except FileNotFoundError:
#         return []  # Return an empty list if the file doesn't exist.
#     # Sorted by the score.
#     for leaderboard in easyHighScores:
#         for score in leaderboard['easyLeaderboard']:
#             print( score['name'], score['value'])
# #     return sorted(easyHighScores, key=itemgetter(1), reverse=True)
# #     print(easyHighScores)
# loadHighScores()
# print(yoTest)
#import images used
...
frame2.columnconfigure((1,2),weight=4)
...
def playMenuMusic():
    loadMusic(projectDirectory + 'menu/menuMusic.mp3')
    playMusic("forever")
#stopwatch functions
...
def submitHighScoreName(currentFrame, highScoreName, playerTime):
    ...
    with open(leaderboardFile, "r+") as writeHighScoreFile:
        ...
        change_between_frames(currentFrame, frame2)

    
def startGame(currentFrame,newFrame):
    playMusic("forever")
    change_between_frames(currentFrame, newFrame)
    loadMusic('/home/pi/Desktop/Python Scripts/timer/countdown.wav')
    playMusic("forever")
    loadCurrentHighScores(leaderboardFile)
    startGameCountdown()
    stopMusic()
...
gazerbeam_logo_label.grid(column=0,row=0)
...
row = 0
col = 0
songName = ["Space", "Moon", "Sprint", "Relax","Trance","Drive","Zoomer","Boom","Gazer"]
songColor = ["#000000","#3DAAD6","#6BAA41","#DEA336","#D94E47","#969FB9","#195C76","#AA2296", "#E88F73"] #"#8A1B7A"
songTextColor = ["#fdfce9","#fdfce9","#fdfce9","#fdfce9","#fdfce9","#fdfce9","#fdfce9","#fdfce9", "#fdfce9"]
